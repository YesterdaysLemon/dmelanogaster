...
manifest={**base,'version':2,'runtimeModel':'walking.xml','modelPath':'walking.xml','files':files,'initialQpos':d.qpos.tolist(),
 ...
 'physics':{'timestep':.0001,'gravity':'9801 mm/s^2','scope':'Experimental NMF anatomy / muscle-driven free body','forceUnit':'microNewton (g, mm, s model convention; uncalibrated strength)'},
