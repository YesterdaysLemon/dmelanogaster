...
import { motionMarkup, initMotion } from "./motion-ui";

const app = document.querySelector<HTMLDivElement>("#app")!;
app.innerHTML = `
<header class="masthead"><a class="identity" href="#terrarium" aria-label="D. melanogaster home"><img src="/favicon.svg" alt="" width="38" height="38"><span><strong>D. melanogaster</strong><small>THE OPEN FLY LABORATORY</small></span></a><nav aria-label="Laboratory"><a href="#terrarium" data-tab="terrarium">Terrarium</a><a href="#motion" data-tab="motion">Motion lab</a><a href="#wiring" data-tab="wiring">Wiring</a><a href="#specimen" data-tab="specimen">Muscle bench</a><a href="#literature" data-tab="literature">Literature</a><a href="#research" data-tab="research">Research</a></nav><a class="repo-link" href="https://github.com/YesterdaysLemon/dmelanogaster" target="_blank" rel="noopener">Source code ↗</a></header>
<main>${terrariumMarkup}${motionMarkup}
<section id="specimen" class="page">
  <div class="page-heading"><div><div class="eyebrow"><span class="status-dot"></span> V0 / MUSCLE BENCH</div><h1>A fly, from the inside out.</h1><p>Anatomy you can inspect. Mechanics you can perturb. Evidence you can follow.</p></div><div class="specimen-stamp">DROSOPHILA MELANOGASTER<br><b>Adult · tethered left foreleg</b></div></div>
  <div class="laboratory">
    <div class="viewport-panel"><div class="viewport-top"><span class="tiny-label">01 / ANATOMICAL VIEW</span><span class="quiet">MuJoCo · in your browser</span></div><div id="viewport"><div id="loading" role="status"><span class="loader"></span><strong>Preparing the specimen</strong><span id="load-detail">Loading anatomy and muscle mechanics…</span></div></div>
    <div class="view-caption"><span><i class="line-key"></i> Selected muscle–tendon path</span><span>Drag to orbit · scroll to zoom</span></div>
    ...
    <div class="scope-note"><span class="scope-icon">↳</span><div><b>This is a mechanical bench.</b> Fifteen foreleg muscle–tendon units receive direct excitation. The separate terrarium explores a neural walking bridge.</div><a href="#research">See the frontier ↗</a></div></div>
    <aside class="inspector"><div class="tiny-label">02 / MUSCLE INSPECTOR</div><div class="section-rule"></div><label class="input-label" for="muscle">LEFT FORELEG · MUSCLE GROUP</label><select id="muscle" disabled><option>Loading anatomical roster…</option></select><h2 id="muscle-title">Tibia flexor</h2><div class="badges"><span>Anatomy-derived path</span><span class="ochre">Fitted mechanics</span></div><p class="inspector-description">Excite a muscle and watch its force act through the original anatomical tendon path.</p><div class="drive-heading"><label for="excitation">Muscle excitation</label><output id="excitation-value" for="excitation">35%</output></div><input id="excitation" type="range" min="0" max="100" value="35" disabled><div class="range-ends"><span>Baseline</span><span>Full excitation</span></div><div class="action-row"><button class="primary" id="pulse" disabled>Apply 50 ms pulse <span>↗</span></button><button class="secondary" id="release" disabled>Release</button></div><p class="microcopy">The slider sets the next pulse. Release returns all muscles to the source model’s 0.01% baseline.</p><div class="live-values"><div><span>Activation</span><strong id="activation">0.000</strong><small>normalized state</small></div><div><span>Tendon force</span><strong id="force">0.00</strong><small>signed model units</small></div></div><details class="provenance"><summary>Inspect this model component</summary><dl><dt>Source actuator</dt><dd id="source-id">—</dd><dt>Tendon attachment sites</dt><dd id="sites">—</dd><dt>Activation / deactivation constants</dt><dd id="constants">—</dd><dt>Motor-neuron assignment</dt><dd>Not reconstructed</dd></dl><p>Numerical identifiers are inherited source names; they are not verified connectome assignments.</p><a href="#literature/flymimic">Read source & assumptions ↗</a></details><a class="source-callout" href="#literature/flymimic"><span>BUILT ON FLYMIMIC</span><b>Follow the evidence <span>↗</span></b></a></aside>
  </div>
